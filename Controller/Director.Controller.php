	...
	class Director
    {
        ...
        public function CrearUsuario() 
        {
            ...
            if(count($usuario)==1)
            {
                ...
                $this->usuasrio->CrearUsuario($usuario[0]['id_Pro_Usuarios'],$user,$pass);
        ...
        public function GuardarUsuario()
        {
            ...
            if($puesto=="Alumno")
            {
                ...
                $dato=$this->usuasrio->CrearInscripcionAlumno($ci[0]['id_Pro_Ciclo'],$car[0]['id_Pro_Carrera'],$gra[0]['id_Pro_grado'],$ni[0]['id_Pro_Nivel'],$idEncargado[0]['id_Pro_Encargado'],$idAlumno[0]['id_Pro_Usuarios']);
            }
        ...
        public function BuscarUsuarios()
        {
            if(isset($_POST['tipo']))
            {
                ...
                if($tipo=="Maestro")
                {
                    $datos=$this->usuasrio->BuscarListarUsuarios($tipo,$carrera[0]['id_Pro_Puesto'],0,0,0,0);
                }
                else
                {
                    ...
                    $datos=$this->usuasrio->BuscarListarUsuarios($tipo,$car,$nivel[0]['id_Pro_Nivel'],$grado[0]['id_Pro_grado'],$carrera[0]['id_Pro_Carrera'],$ciclo[0]['id_Pro_Ciclo']);
        ...
        {
            //echo "--------------------------------------------------ActualizarUsuario: id-> ".$_GET['id']." --Tipo: ".$_GET['tipo']."<br>";
        ...
        public function GuardarCurso()
        {
            ...
            $this->educativo->CrearMalla($idC[0]['id_Pro_Carrera'],$idG[0]['id_Pro_grado'],$idN[0]['id_Pro_Nivel'],$curso);
        ...
        public function ConsultaMalla()
        {
            ...
            $datos=$this->educativo->BuscarMalla($idN[0]['id_Pro_Nivel'],$idG[0]['id_Pro_grado'],$idC[0]['id_Pro_Carrera']);
