              ...
              <form class="needs-validation" novalidate>
                  <div class="form-row">
                      <div class="form-group col-md-6 py-3 ">
                          ...
                          <input type="text" class="form-control " id="Nombre_1" required>
                      </div>
                      <div class="form-group col-md-6 py-3 ">
                      ...
                      <div class="form-group col-md-6 py-3 ">
                          ...
                          <input type="date" class="form-control" id="DateTimePicker" required>
                      </div>
                      <div class="form-group col-md-6 py-3 ">
                    ...
                    <div class="form-group col-md-6 py-3 ">
                      ...
                      <input type="text" class="form-control" id="punteo" >
                  </div>
