<?php
	class Usuario
    {
        ...
        public function CrearUsuario($id, $user, $pass)
        {
            return $this->medoo->update("Pro_UsuarioColegio",
                        [
                            "Usuario"=>$user,
        ...
        public function CrearInscripcionAlumno($ciclo,$carrera,$grado,$nivel,$encargado,$alumno)
        {
        ...
        public function BuscarListarUsuarios($puesto,$tipo,$nivel,$grado,$carrera,$ciclo)
        {
            if($puesto=="Maestro")
            {
                return $this->medoo->select('Pro_UsuarioColegio',"*",[
